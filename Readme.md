...
Implemented hash map data structure and read in words from dictionary.txt to create spell checker that prompts user for a word and checks if the word is present. If not, calculated Levenshtein distance to suggest 5 closest words from dictionary.
